        ...
        <div class="card-body">
            ...
            <div class="text-center mt-5 mb-5" style="border: none;">
                ...
                <div class="btn-group" role="group" aria-label="Form Choice">
                    <?= Html::a('Fill Form Manually', ['employee/apply'], ['class' => 'btn btn-primary', 'style' => 'background-color: rgb(104, 146, 213); margin-right: 10px;']) ?>
                    <?= Html::a('Upload Resume', ['employee/upload'], ['class' => 'btn btn-secondary', 'style' => 'background-color: rgb(104, 146, 213);']) ?>
                </div>
            </div>
        </div>
    </div>
