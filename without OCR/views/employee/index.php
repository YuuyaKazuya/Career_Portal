...
$this->title = 'Employment Applicant';
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-auto align-self-center">
                    <h6 class="d-inline-block mb-0" style="font-size: 24px; color: white;">Applicant for Employment</h6>
                </div>
            </div>
        </div>
            ...
            <table class="table footable" data-show-toggle="true">
                <thead style="background-color: transparent;">
                    <tr class="text-muted">
                        ...
                        <th data-breakpoints="xs sm">Position Applied</th>
                        <th data-breakpoints="xs sm">Availability</th>
                        <th>Resume</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <p class="mb-0" style="color: white;"><?= $v->jobType0 !== null ? htmlspecialchars($v->jobType0->jobType) : '' ?></p>
                            <p class="text-secondary small" style="color: white;"><?= $v->job0 !== null ? htmlspecialchars($v->job0->title) : '' ?></p>
                        </td>
                        <td>
                            <p class="mb-0" style="color: white;"><?= Html::encode((new DateTime($v->date))->format('d F Y')) ?></p>
                        </td>
                        <td>
                            <?php if ($v->resume): ?>
